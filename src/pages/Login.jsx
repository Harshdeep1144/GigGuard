...
export default function Login({ setAuth, setActiveTab }) {
    ...
    <div className="min-h-[calc(100vh-12rem)] flex flex-col items-center justify-center animate-fadeIn w-full">
      <div className="w-full max-w-md md:max-w-lg bg-slate-900/80 backdrop-blur-xl border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-2xl shadow-black/50 mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 font-medium">Sign in to GigGuard to manage your protection.</p>
        </div>
        ...
        <p className="mt-8 text-center text-slate-400 text-sm font-medium">
          ...
          <button onClick={() => setActiveTab('signup')} className="text-indigo-400 hover:text-indigo-300 font-bold hover:underline transition-all">
            Sign up
          </button>
        </p>
      </div>
